...
def interface_visual():
    ...
    while True:
        ...
        if event =='Gráfico':
            ...
            salario_liquido_list, irrf_recolhido_list, salario_base_list, adicoes_list, salario_base_de_calculo_list, total_deducoes_list = preparar_graficos(salario_liquido, irrf_recolhido, adicoes, salario_base_de_calculo, total_deducoes)
            ...
            salario_base, salario_bruto, salario_base_de_calculo, salario_liquido, irrf_recolhido, aliquota_ = preparar_relatorio(salario_base, salario_bruto, salario_base_de_calculo, salario_liquido, irrf_recolhido)
...
def preparar_graficos(salario_liquido, irrf_recolhido, adicoes, salario_base_de_calculo, total_deducoes):
...
def preparar_relatorio(salario_base, salario_bruto, salario_base_de_calculo, salario_liquido, irrf_recolhido):
