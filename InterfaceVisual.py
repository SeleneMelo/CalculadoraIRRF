...
def interface_visual():
    ...
    while True:
        ...
        if event =='Gráfico':
            ...
            salario_liquido_list, irrf_recolhido_list, salario_base_list, adicoes_list, salario_base_de_calculo_list, total_deducoes_list = logicacalculadora.preparar_graficos(salario_liquido, irrf_recolhido, salario_base, adicoes, salario_base_de_calculo, total_deducoes)
            ...
            salario_base, salario_bruto, salario_base_de_calculo, salario_liquido, irrf_recolhido, aliquota_ = logicacalculadora.preparar_relatorio(salario_base, salario_bruto, salario_base_de_calculo, salario_liquido, irrf_recolhido)
